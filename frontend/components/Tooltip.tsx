    ...
    <div className="relative inline-flex" ref={tooltipRef}>
      ...
      {isVisible && (
        ...
        >
          {text}
          <div
            className={`absolute w-2 h-2 bg-gray-900 rotate-45 ${position === "top" ? "top-full left-1/2 -translate-x-1/2 -mt-1" : position === "bottom" ? "bottom-full left-1/2 -translate-x-1/2 -mb-1" : position === "left" ? "right-full top-1/2 -translate-y-1/2 -mr-1" : "left-full top-1/2 -translate-y-1/2 -ml-1"}`}
          />
        </div>
      )}
    </div>
