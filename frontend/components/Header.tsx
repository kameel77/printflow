...
export default function Header({ title = 'Printflow MIS', subtitle = 'Kalkulacja prod. masowa', actions, backHref }: HeaderProps) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        {backHref ? (
                            <Link href={backHref} className="p-2 -ml-2 text-gray-400 hover:text-gray-600 rounded-lg transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {/* Hamburger Menu Area */}
                        <div className="relative border-l border-gray-200 pl-3 flex items-center gap-3" ref={menuRef}>
                            
                            {user && (
                                <div className="hidden md:flex flex-col items-end mr-2">
                                    <span className="text-xs font-medium text-gray-700">{user.email}</span>
                                    <button onClick={logout} className="text-xs text-gray-500 hover:text-red-600 transition-colors">Wyloguj</button>
                                </div>
                            )}
