        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          {variants.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              <p>
                Brak wariantów. Wróć do kalkulatora, aby dodać wariant z
                kalkulacji.
              </p>
              <Link
                href="/"
            ...
            <div className="space-y-4">
              {variants.map((v) => (
                <div
                  key={v.id}
                  className={`rounded-xl border-2 p-5 transition-colors ${v.isRecommended ? "border-emerald-300 bg-emerald-50/30" : "border-gray-200"}`}
                >
                            ...
                            <td className="px-4 py-2 text-center">
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  const vIdx = newVariants.findIndex(
                                    (vr) => vr.id === v.id,
                                  );
                                  newVariants[vIdx].components[
                                    ci
                      ...
                      <div className="mt-3 flex items-center justify-between pt-3 border-t">
                        ...
                        <div className="text-right">
                          {isB2B ? (
                            ...
                            <>
                              <p className="text-lg font-bold text-gray-900">
                                {formatCurrency(v.totalPriceGross)}{" "}
                                <span className="text-sm font-normal text-gray-500">
                                  brutto
                                </span>
                              </p>
                              <p className="text-sm text-gray-500">
                                {formatCurrency(v.totalPriceNet)} netto
                              </p>
                            </>
                          )}
                        </div>
